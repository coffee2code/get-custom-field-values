...
define( 'GET_CUSTOM_FIELD_VALUES_PLUGIN_DIR',  dirname( __FILE__, 3 ) );
define( 'GET_CUSTOM_FIELD_VALUES_PLUGIN_FILE', GET_CUSTOM_FIELD_VALUES_PLUGIN_DIR . '/get-custom-field-values.php' );

$polyfill_path = GET_CUSTOM_FIELD_VALUES_PLUGIN_DIR . '/vendor/yoast/phpunit-polyfills/phpunitpolyfills-autoload.php';
